...
#include <windows.h> // plik nag³ówkowy dla Windows
#include <math.h> // plik nag³ówkowy dla biblioteki matematycznej
#include <stdio.h> // plik nag³ówkowy dla we/wy standardowego
#include <stdlib.h> // plik nag³ówkowy dla bibioteki standardowej
#include <gl\gl.h> // plik nag³ówkowy dla biblioteki OpenGL32
#include <gl\glu.h> // plik nag³ówkowy dla biblioteki GLu32
#include <GL\glut.h> // plik nag³ówkowy dla biblioteki Glut
...
DEVMODE DMsaved; // zachowaæ ustawienia przesz³ego trybu



GLfloat rotz = 0.0f; // obroty wspó³rzêdnej Z
...

{
	...
	GLsizei width_texture, height_texture; // zmienne u¿yte przy obs³udze plików TARGA
	GLenum format, type;
